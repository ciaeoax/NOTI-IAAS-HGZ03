...
async function submitForm() {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbwCJNrwC_bBLVVdh0p_FTlrnHcSSkTWyCn8P3OroGxGshsFFY_eOheXNB8nvi2JhFhGBw/exec', { // Replace with your Google Apps Script URL
            method: 'POST',
            headers: {
