...
function exportarExcel() {
    ...
    titulo = "HGZ03_IAAS_"+messs+"_"+fechaFormateada+".xlsx";
    // -- 
...
async function getData(dates) {
    ...
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbxwUPzVrlc0ed2iaNh4kYhCxZT6ucTn4dGL5hd8m58l9pVdQ-Pl5SB3A3rLbxX78gV3Ow/exec', { // Replace with your Google Apps Script URL
            method: 'POST',
            headers: {
